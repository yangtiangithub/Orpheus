...
if __name__ == "__main__":
    ...
    cfg.ltp_seg_model_path = "../utils/ltp/models/cws.model"
    cfg.ltp_seg_lexicon_path = "../utils/ltp/user_lexicon.txt"
    cfg.ltp_pos_model_path = "../utils/ltp/models/pos.model"
    cfg.ltp_rec_model_path = "../utils/ltp/models/ner.model"
    cfg.ltp_par_model_path = "../utils/ltp/models/parser.model"
